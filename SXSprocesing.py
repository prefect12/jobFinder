...
#stopWordDir = ['./stopwords/baidu_stopwords.txt','./stopwords/cn_stopwords.txt','./stopwords/scu_stopwords.txt']
#for i in stopWordDir:    
#    stopword = stopword.append(pd.read_csv(i,header=None))
#stopword = stopword.drop_duplicates()
#stopword.to_csv('./stopwords/sum.txt',index=False)
...
#words = np.concatenate(df.jobDesWord)
#wordDf = pd.DataFrame({'Word':words})
